...
func TestDecryptRequiresIdentity(t *testing.T) {
	...
	if !strings.Contains(err.Error(), "sudo envoyage keygen") {
		t.Fatalf("error = %q, want keygen hint", err.Error())
	}
}
...
func TestDecryptReportsIdentityAndCiphertextErrors(t *testing.T) {
	...
	if !strings.Contains(err.Error(), "--identity /path/to/age-key.txt") {
		t.Fatalf("missing identity error = %q, want identity hint", err.Error())
	}
	...
	if !strings.Contains(err.Error(), "generated by envoyage keygen") {
		t.Fatalf("bad identity error = %q, want keygen hint", err.Error())
	}
	...
	if !strings.Contains(err.Error(), "matching the recipient") {
		t.Fatalf("invalid ciphertext error = %q, want recipient hint", err.Error())
	}
}
...
func TestEncryptFileValidatesRequiredInputs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantHint && !strings.Contains(err.Error(), "hint:") {
